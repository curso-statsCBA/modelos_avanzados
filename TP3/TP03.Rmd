---
title: "Práctico 3. Datos de conteo"
output:
  html_document:
    highlight: tango
---
...
5. ¿Tiene usted datos de conteos, inflados o no en ceros? (n > 30). Discuta con sus compañeres de mesa, 
prestando especial atención a: a) el proceso que originaron los datos, b) una estrategia global de 
análisis, c) las posibles fuentes de sobredispersión. Presente sus datos con gráficos y análisis 
(o al menos los pasos a seguir en el análisis). En caso de utilizar datos inflados en ceros recuerde 
instalar el paquete `pscl`.
